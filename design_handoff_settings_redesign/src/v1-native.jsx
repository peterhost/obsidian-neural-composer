    ...
    <ModalChrome theme={theme}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div
            style={{ fontSize: 13, fontWeight: 600, color: theme.textNormal }}
          >
            Neural Composer
          </div>
      ...
      <div
        style={{
          ...
          justifyContent: 'space-between',
          padding: '8px 18px',
          borderTop: `1px solid ${theme.bgModifierBorder}`,
    ...
    <div>
      <div style={{ marginBottom: 4 }}>
        ...
        <p style={{ margin: '6px 0 0', color: theme.textMuted, fontSize: 13 }}>
          Habilita los modelos que quieres usar en chat y embeddings. Los
          modelos activos aparecen en el selector del chat.
        </p>
      </div>
      ...
      >
        ...
        <ActiveSelector
          ...
          value="text-embedding-004 (768d)"
          badge="gemini"
        />
        <ActiveSelector
          theme={theme}
          label="Graph logic (LLM)"
          value="Same as chat model"
          badge={null}
        />
      </div>
        ...
        {providerSet.map((p) => {
          ...
          return (
            ...
            >
              ...
              <span
                style={{
                  color: sel ? theme.textAccent : theme.textFaint,
                  fontSize: 11,
                }}
              >
                {count}
        ...
        {filtered.map((m, i) => (
          <div
            ...
            style={{
              ...
              borderTop:
                i === 0 ? 'none' : `1px solid ${theme.bgModifierBorder}`,
...
const ProvidersTab = ({ theme, dense }) => (
  <div>
    ...
    <p style={{ margin: '6px 0 20px', color: theme.textMuted, fontSize: 13 }}>
      Tus API keys de los providers configurados.{' '}
      <a href="#" style={{ color: theme.textAccent }}>
    ...
    >
      {PROVIDERS.map((p, i) => (
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontWeight: 500, color: theme.textNormal }}>
                {p.name}
              </span>
              {p.custom && (
          ...
          <Button theme={theme} variant="ghost" icon="edit">
            Edit
          </Button>
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
      {PROVIDER_OPTIONS.map((p) => (
        ...
        >
          ...
          {p}
          <span style={{ color: theme.textFaint, marginLeft: 4 }}>
...
const ChatTab = ({ theme, dense }) => (
  <div>
    ...
    <SettingRow
      ...
      control={
        <Select value="gemini-3-flash-preview" theme={theme} width={220} />
      }
    />
    <SettingRow
      theme={theme}
...
const GraphTab = ({ theme, dense }) => (
  <div>
    ...
    <p style={{ margin: '6px 0 12px', color: theme.textMuted, fontSize: 13 }}>
      Conexión con LightRAG, sincronización del vault y configuración del grafo
      de conocimiento.
    </p>

    <SectionHeading
      theme={theme}
      title="Neural backend (LightRAG)"
      desc="Servidor que indexa y consulta tu grafo"
    />
    <SettingRow
      theme={theme}
      dense={dense}
    ...
    <SettingRow
      ...
      control={
        <input
          placeholder="Vacío si no requiere"
          style={{
            width: 240,
            padding: '6px 10px',
            borderRadius: 6,
    ...
    <SettingRow
      ...
      control={
        <Select value="2D · rápido y limpio" theme={theme} width={200} />
      }
    />
    ...
    <details style={{ marginTop: 24 }}>
      ...
      >
        Categorías personalizadas, reranking provider, modelo de reranking,
        edición directa del .env del servidor…
      </div>
    </details>
  </div>
)
...
const ToolsTab = ({ theme, dense }) => (
  <div>
    ...
    >
      ...
      <div>
        <strong>Atención:</strong> el resultado de las tools se inyecta en el
        contexto del LLM. Resultados largos aumentan el consumo de tokens y el
        coste.
      </div>
    </div>
...
const AdvancedTab = ({ theme, dense }) => (
  <div>
    ...
    <p style={{ margin: '6px 0 16px', color: theme.textMuted, fontSize: 13 }}>
      Configuración de bajo nivel del servidor LightRAG. Solo para usuarios
      avanzados.
    </p>
