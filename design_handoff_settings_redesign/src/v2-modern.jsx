    ...
    <ModalChrome theme={theme}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div
              style={{ fontSize: 11.5, color: theme.textFaint, marginTop: 1 }}
            >
      ...
      >
        ...
        >
          ...
          {tab === 'providers' && (
            <ProvidersModernTab theme={theme} dense={dense} />
          )}
          ...
          {tab === 'advanced' && (
            <AdvancedModernTab theme={theme} dense={dense} />
          )}
        </div>
      </div>
    </ModalChrome>
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <Badge
              label={`${totalEnabled} activos`}
              tone="accent"
              theme={theme}
              dot
            />
            <Badge
              label={`${models.length} disponibles`}
              tone="neutral"
              theme={theme}
            />
          </div>
        ...
        {Object.entries(groups).map(([prov, ms]) => {
          ...
          return (
            ...
            >
              <button
                onClick={() =>
                  setExpanded({ ...expanded, [prov]: !isExpanded })
                }
                style={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              {isExpanded && (
                <div
                  style={{ borderTop: `1px solid ${theme.bgModifierBorder}` }}
                >
                  {filtered.map((m, i) => (
                    <div
                      key={m.id}
                      style={{
                        ...
                        borderTop:
                          i === 0
                            ? 'none'
                            : `1px solid ${theme.bgModifierBorder}33`,
                      }}
                    >
                      <span
                        style={{
          ...
          {window.EMBEDDING_MODELS.map((m, i) => (
            <div
              ...
              style={{
                ...
                padding: '10px 14px',
                borderTop:
                  i === 0 ? 'none' : `1px solid ${theme.bgModifierBorder}33`,
              }}
            >
...
const ActiveCard = ({ theme, label, value, provider, sub }) => (
  ...
  >
    ...
    {sub && (
      <div style={{ color: theme.textFaint, fontSize: 10.5, marginTop: 3 }}>
        {sub}
      </div>
    )}
  </div>
  ...
  <div>
    ...
    >
      ...
      <p style={{ margin: '8px 0 0', color: theme.textMuted, fontSize: 12.5 }}>
        Tus API keys se guardan localmente en tu vault.{' '}
    ...
    <SectionHeading
      theme={theme}
      title="Disponibles"
      desc="Configura una API key para activar"
    />
  ...
  <div>
    ...
    >
      ...
      >
        <div>
          <div
            style={{ color: theme.textNormal, fontSize: 13.5, fontWeight: 600 }}
          >
            System prompt
          </div>
          <div style={{ color: theme.textMuted, fontSize: 12, marginTop: 2 }}>
            Se añade al inicio de cada conversación
          </div>
        </div>
  ...
  <div>
    ...
    >
      ...
      >
        <div>
          <div
            style={{ color: theme.textNormal, fontSize: 14, fontWeight: 600 }}
          >
            LightRAG Server
          </div>
          <div style={{ color: theme.textMuted, fontSize: 12, marginTop: 3 }}>
            Servidor neural conectado y operativo
          </div>
        </div>
  ...
  <div>
    ...
    >
      ...
      <div style={{ color: theme.textNormal, opacity: 0.9 }}>
        ...
        Resultados largos pueden aumentar significativamente el consumo de
        tokens.
      </div>
    </div>
    ...
    >
      ...
      <div style={{ fontSize: 12, marginTop: 4 }}>
        Conecta servidores para añadir herramientas a la IA
      </div>
    </div>
  </div>
)
